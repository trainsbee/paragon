        ...
        <div class="card pauses">
            ...
            <div class="profile">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">10:28:34 - En curso</span>
                </div>
            </div>
            <div class="profile">
                <h3>razon 2</h3>
                <div class="info-row">
                    <span class="info-label">Tiempo:</span>
                    <span class="info-value">10:28:34 - 10:29:15</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Duración:</span>
                    <span class="info-value">00:41:15</span>
                </div>
            </div>
        </div>
        <div class="card">
            ...
            try {
                ...
                for (const [date, dailyPauses] of Object.entries(pausesByDate)) {
                    ...
                    dailyPauses.forEach(pause => {
                        ...
                        profileDiv.className = `profile ${!pause.end_time ? 'in-progress' : ''}`;
                        ...
                        pauseList.appendChild(profileDiv);
                    });
                }
